...
{	
	...
	if(mysqli_query($conn,"INSERT INTO users (u_mobile,s_ans,s_question,u_gender,u_pass,u_address,f_name,l_name,u_bday,u_position,u_type,u_email)VALUES('$u_mobile','$s_ans','$s_question','$u_gender','$u_pass','$u_address','$f_name','$l_name','$u_bday','$u_position','$u_type','$u_email')"))
		{
			?>
