...
{	
	...
	if(mysqli_query($conn,"UPDATE users SET u_mobile='$u_mobile',s_ans='$s_ans',s_question='$s_question',u_gender='$u_gender',u_pass='$u_pass',u_address='$u_address',f_name='$f_name',l_name='$l_name',u_bday='$u_bday',u_position='$u_position',u_type='$u_type' WHERE u_email='$u_email'"))
		{
			?>
